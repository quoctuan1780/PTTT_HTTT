...
public class KhachHangGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("KHÁCH HÀNG ĐẶT PHÒNG TRỰC TIẾP");
        ...
        jPanel3.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 70, 20));
        ...
        jPanel4.add(bt_thuephong, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 170, 250, 40));
    ...
    private void bt_thuephongActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_thuephongActionPerformed
        int selected = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn thuê phòng này ?",
                 "Thông báo", JOptionPane.YES_NO_OPTION);
        if (selected == JOptionPane.YES_NO_OPTION)
        {
            if (!txt_makh.getText().equals(""))
            {
                makh = Integer.parseInt(txt_makh.getText());
                java.util.Date date = new java.util.Date(); 
                int luiform = 2;
                PhieuThuePhongGUI ptp = new PhieuThuePhongGUI(luiform, maphong, makh, date);
                ptp.setVisible(true);
                this.dispose();
            }
        }
